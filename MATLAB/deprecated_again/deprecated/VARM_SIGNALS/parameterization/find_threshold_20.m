...
%% Multi-Trial
thresholds = .03:.01:.15;
[Fmeasure, precision, recall, NMI, num_of_edges] = deal(zeros(length(thresholds),2));
for k = 1:length(thresholds)
    ...
    parfor t = 1:global_params.trials
        ...
        % L_0 = L/trace(L)*global_params.N/2;
        % A_0 = laplacian_to_adjacency(L_0);
