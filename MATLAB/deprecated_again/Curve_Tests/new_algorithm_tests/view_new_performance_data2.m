...
load("large_new_performance_data_results_z_n10.mat")
load("large_new_performance_data_results_z_n20.mat")
load("large_new_performance_data_results_z_n40.mat")

load("large_new_performance_data_results_z_n20_test.mat")

%% N = 40
plot_perf(1,1,S_ER_40,F_ER_40);
% plot_perf(1,2,S_BA_40,F_BA_40);
% plot_perf(1,3,S_RND_40,F_RND_40);
%% N = 20
plot_perf(2,1,S_ER_20,F_ER_20);
% plot_perf(1,2,S_BA_20,F_BA_20);
% plot_perf(1,3,S_RND_20,F_RND_20);
%% N = 10
plot_perf(3,1,S_ER_10,F_ER_10);
% plot_perf(2,2,S_BA_10,F_BA_10);
% plot_perf(2,3,S_RND_10,F_RND_10);
%%
load("large_new_maximum_data_results_n40_n20_n10.mat");
%% N = 40
plot_max(1,1,S_ER_40,F_ER_40);
% plot_max(1,2,S_BA_40,F_BA_40);
% plot_max(1,3,S_RND_40,F_RND_40);
%% N = 20
plot_max(2,1,S_ER_20,F_ER_20);
% plot_max(1,2,(1:10)*2/20,F_BA_20(:,:,1:10));
% plot_max(1,3,S_RND_20,F_RND_20);
%% N = 10
plot_max(3,1,S_ER_10,F_ER_10);
