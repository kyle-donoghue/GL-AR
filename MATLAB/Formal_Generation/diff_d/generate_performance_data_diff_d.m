...
for i = 1:length(Q)
    ...
    AR_params = GL.create_default_params(signal_params);
    signal_params.min_delay = Q(i);
    signal_params.max_delay = Q(i);    [F_list(i,:)] = run_performance_sims(signal_params,AR_params,graph_param,trials);
    i/length(Q)*100
    toc
    tic
end
...
F_RND_20 = F_list;
%%
save("../../Formal_Data/diff_d/performance_data_diff_Q_rect_FINAL_40.mat")