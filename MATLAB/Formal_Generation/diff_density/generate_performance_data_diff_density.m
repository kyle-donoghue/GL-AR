...
AR_params = GL.create_default_params(signal_params);
[F_RND_20,S_RND_20,T_RND_20] = run_performance_sims(signal_params,AR_params,rnd_param,trials);
signal_params = signals.create_default(20,'pa');
AR_params = GL.create_default_params(signal_params);
[F_BA_20,S_BA_20,T_BA_20] = run_performance_sims(signal_params,AR_params,ba_param,trials);

%%
save("../../Formal_Data/diff_density/performance_data_diff_density_FINAL.mat")
